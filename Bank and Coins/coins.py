...
class Coin:
    def __init__(self, rare=False, clean=True, heads=True, **kwargs):
        ...
        if self.is_clean:
            self.value = self.clean_colour
        else:
            self.value = self.rusty_colour
    ...
    def flip(self):
        ...
        self.heads = random.choice(face_options)
...
for coin in coins:
    arguments = [coin, coin.clean_colour, coin.value, coin.diameter, coin.thickness,
